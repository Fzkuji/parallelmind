...
#   - 训练分支配置: fixed1, 1-3, 1-7, 1-15
#   - 评估分支: 1, 2, 4, 8, 16, 24, 32, 48, 64
#
# 总实验数: 5 ratios × 4 configs = 20 个训练 + 180 个评估
#
# ============================================================================
...
# 相比 512 模型，减半 batch 加倍 accum 以降低显存压力
TRAIN_CONFIGS=(
    # 固定 1 分支 (baseline)
    "1,1,4,2"      # fixed=1, batch=4, accum=2, tokens=8×4×2×1×512=32,768
    # 动态分支: 按平均分支数计算
    "1,3,2,2"      # avg=2,  batch=2, accum=2, tokens=8×2×2×2×512=32,768
    "1,7,1,2"      # avg=4,  batch=1, accum=2, tokens=8×1×2×4×512=32,768
